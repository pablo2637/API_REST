    ...
    try {
        ...
        if (peticion.ok)
            ...
            if (servicio.servicio == '')
                error = response.errors.servicio.msg;

            else if (servicio.descripcion == '')
                error = response.errors.descripcion.msg;
...
const postProducto = async (req, res) => {
    ...
    try {
        ...
        if (peticion.ok)
            ...
            if (producto.tipo == '')
                error = response.errors.tipo.msg

            else if (producto.descripcion == '')
                error = response.errors.descripcion.msg

            else if (producto.precio == '')
                error = response.errors.precio.msg
    ...
    try {
        ...
        if (peticion.ok)
            ...
            if (producto.tipo == '')
                ...
                error = response.errors.imagen.msg
